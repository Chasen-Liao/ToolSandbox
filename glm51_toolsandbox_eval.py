    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "query": {"type": "string", "description": "Company name or stock query"},
                },
                "required": ["query"],
            },
        },
...
def generate_markdown_report(report: EvalReport) -> str:
    lines = []
    lines.append(f"# ToolSandbox Evaluation Report  [{report.model}]")
    lines.append("")
...
if __name__ == "__main__":
    ...
    json_path = "glm51_toolsandbox_report.json"
